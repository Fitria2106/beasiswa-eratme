    ...
    <div class="container">
        ...
        <div class="collapse navbar-collapse" id="navbarNav">
            <ul class="navbar-nav ms-auto">
                <li class="nav-item">
                    <a class="nav-link active fw-bold" href="<?php echo e(route('login')); ?>">Masuk</a>
                </li>
                <li class="nav-item">
...
</script><?php /**PATH C:\Users\Dell\reportbook\resources\views/auth/login.blade.php ENDPATH**/ ?>