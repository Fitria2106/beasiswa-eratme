            ...
            <div class="col-md-6 text-md-end text-center mt-3 mt-md-0">
                <?php if(Route::has('login')): ?>
                    <?php if(auth()->guard()->check()): ?>
                        <a href="<?php echo e(url('/dashboard')); ?>" class="btn btn-primary shadow-sm px-4">Buka Dashboard</a>
                    <?php else: ?>
                        <a href="<?php echo e(route('login')); ?>" class="btn btn-outline-primary me-2">Masuk</a>
                        <?php if(Route::has('register')): ?>
                            <a href="<?php echo e(route('register')); ?>" class="btn btn-primary shadow-sm">Daftar Akun</a>
                        <?php endif; ?>
                    <?php endif; ?>
                <?php endif; ?>
            </div>
...
</html><?php /**PATH C:\Users\Dell\reportbook\resources\views/welcome.blade.php ENDPATH**/ ?>