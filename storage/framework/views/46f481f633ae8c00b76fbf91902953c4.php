            ...
            <div class="row g-4 mb-5 no-print">
                <div class="col-md-4">
                    <div class="card card-stats p-4 bg-white border-start border-primary border-5 h-100">
                        ...
                        <h2 class="fw-bold mb-0"><?php echo e($allReports->unique('user_id')->count()); ?> Orang</h2>
                    </div>
                </div>
                ...
                <div class="col-md-4">
                    <div class="card card-stats p-4 bg-white border-start border-success border-5 h-100">
                        ...
                        <h2 class="fw-bold mb-0"><?php echo e($allReports->count()); ?> Item</h2>
                    </div>
                </div>
            ...
            <div class="modal-content border-0 shadow-lg rounded-4">
                ...
                <div class="modal-body p-4 text-center">
                    <div class="row g-2 mb-3">
                        ...
                        <img src="<?php echo e($report->foto_nota ? asset('storage/'.$report->foto_nota) : 'https://placehold.co/400x300?text=No+Image'); ?>" 
                ...
                <div class="modal-footer border-0 justify-content-center pb-4">
                    <form action="<?php echo e(route('admin.report.status', ['id' => $report->id, 'status' => 'disetujui'])); ?>" method="POST"> 
                        <?php echo csrf_field(); ?> 
