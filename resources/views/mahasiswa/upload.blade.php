<x-app-layout>
            ...
            <div class="col-lg-8">
                ...
                <div class="card shadow-lg">
                    <div class="card-body p-5">
                        ...
                        <form action="{{ route('mahasiswa.store') }}" method="POST" enctype="multipart/form-data" id="uploadForm">
                            @csrf

                            <div x-data="{ jenis: 'barang_penunjang' }">
    ...
    <script>
        function toggleRingkasan() {
            ...
            const box = document.getElementById('box_ringkasan');
            if (jenis === 'buku') {
